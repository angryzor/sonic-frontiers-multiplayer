...
namespace app::camera {
    class MultiplayerCameraService
    ...
    public:
        ...
        CameraBridgeUnit cameraBridges[2][3];
        ...
        hh::fnd::Handle<hh::fnd::Messenger> GetCameraFrame(int index);
        static hh::fnd::Handle<hh::fnd::Messenger> GetCameraFrame(hh::game::GameManager gameManager, int index);

        GAMESERVICE_CLASS_DECLARATION(MultiplayerCameraService)
    };
}
*/
